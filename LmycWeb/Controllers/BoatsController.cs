...
namespace LmycWeb.Controllers
{
    public class BoatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BoatId,BoatName,LengthInFeet,Make,Year")] Boat boat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BoatId,BoatName,LengthInFeet,Make,Year")] Boat boat)
        {
            if (id != boat.BoatId)
            {
                return NotFound();
