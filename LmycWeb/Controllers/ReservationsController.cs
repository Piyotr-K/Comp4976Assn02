...
namespace LmycWeb.Controllers
{
    ...
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,StartDate,EndDate,CreatedBy,BoatId")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,StartDate,EndDate,CreatedBy,BoatId")] Reservation reservation)
        {
